...
class Subsession(BaseSubsession):
    def creating_session(self):
        ...
        self.session.vars['aa_treatment'] = 'AA' in treatment
        self.session.vars['ra_treatment'] = 'RA' in treatment
        self.session.vars['cc_treatment'] = 'CC' in treatment
        self.session.vars['nc_treatment'] = 'NC' in treatment
        self.session.vars['wtp_treatment'] = 'WTP' in treatment
        self.session.vars['payment_room_1'] = random.randint(1, 2)
